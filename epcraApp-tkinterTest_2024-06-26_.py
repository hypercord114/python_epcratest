...
class Window:
    ...
    def popBlankWindow(self,root,height,width,center_frame,btm_frame,dataDirUpdatefiles,dataDirDbfiles):
        ...
        def on_select(event):
            ...
            comboBoxUnitsRec.bind("<<ComboboxSelected>>")
        ...
        def submitData():      
            ...
            if(comboBoxChem_selection.get()=="Not listed"):
                ...
                if (onsiteQuantEntryRec.get()=="" or
                    recvdQuantEntryRec.get()=="" or
                    chemNameEntryRec.get()=="" or
                    comboBoxUnitsRec_selection.get()==""):
                    ...
                    if(cas1NumEntry.get()=="" and
                    cas2NumEntry.get()=="" and
                    cas3NumEntry.get()=="" and
                    cas4NumEntry.get()=="" and
                    cas5NumEntry.get()=="" and
                    casNumConfirmed==False):
    ...
    ## define on_select function
    #def on_select(self,event,btm_frame,center_frame_right,comboBoxChem_selection,epcradat,dataDirUpdatefiles,dataDirDbfiles):
    #
    #    # define function to check values in Entry boxes
    #    def validate_int(char):
    #        if char!="":
    ...
    #
    #    # combobox widgets
    #    comboBoxUnitsRec_selection=tk.StringVar(self)
    #    comboBoxUnitsRec=ttk.Combobox(center_frame_right, values=["Lbs","Gal","55gal Drums","Tons","Other"],textvariable=comboBoxUnitsRec_selection)
    #    comboBoxUnitsRec.name="cb3"
    #    comboBoxUnitsRec.bind("<<ComboboxSelected>>")
    #
    #    # declare buttons for btm_frame
    #    submit_btn=tk.Button(btm_frame, text="Submit", width=10, command=self.submitData(comboBoxChem_selection,comboBoxUnitsRec_selection,center_frame_right,epcradat,dataDirUpdatefiles,dataDirDbfiles))
    #    next_btn=tk.Button(btm_frame, text="Next Entry", width=10)
    #    
    #    # grid buttons
    #    submit_btn.grid(row=0, column=0, sticky="e")
    ...
    ## define function to capture all data, create dict and pass to other class
    ## for processing when submit button is clicked
    #def submitData(self,comboBoxChem_selection,comboBoxUnitsRec_selection,center_frame_right,epcradat,dataDirUpdatefiles,dataDirDbfiles):      
    #        
    #    # logical to check if entry update or new entry is submit
    #    if(comboBoxChem_selection.get()=="Not listed"):
    #
    #        # logical to check if data was entered
    #        if (center_frame_right.onsiteQuantEntryRec.get()=="" or
    #            center_frame_right.recvdQuantEntryRec.get()=="" or
    #            center_frame_right.chemNameEntryRec.get()=="" or
    #            center_frame_right.comboBoxUnitsRec_selection.get()==""):
    #            
    #            # message box
    #            mb.showinfo("Confirm entry","Chemical name, units, quantity onsite and\nquantity received must all be entered.")
    #
    ...
    #
    #            # logical to check that CAS numbers were entered
    #            if(center_frame_right.cas1NumEntry.get()=="" and
    #               center_frame_right.cas2NumEntry.get()=="" and
    #               center_frame_right.cas3NumEntry.get()=="" and
    #               center_frame_right.cas4NumEntry.get()=="" and
    #               center_frame_right.cas5NumEntry.get()=="" and
    #               center_frame_right.casNumConfirmed==False):
    #
    #                # message box confirming no CAS numbers
    #                confRespCas1=mb.askyesno("Confirm entry","There were no CAS numbers entered.\nAre CAS numbers listed in the chemical composition section of the SDS?")
    #   
    ...
    #
    #            # logical checking on complete CAS entries
    #            if( (center_frame_right.cas1NumEntry.get()!="" and center_frame_right.cas1PercEntry.get()!="") or
    #                (center_frame_right.cas2NumEntry.get()!="" and center_frame_right.cas2PercEntry.get()!="") or
    #                (center_frame_right.cas3NumEntry.get()!="" and center_frame_right.cas3PercEntry.get()!="") or
    #                (center_frame_right.cas4NumEntry.get()!="" and center_frame_right.cas4PercEntry.get()!="") or
    #                (center_frame_right.cas5NumEntry.get()!="" and center_frame_right.cas5PercEntry.get()!="") or
    #                 center_frame_right.casNumConfirmed!=True ):
    #
    #                # logical checking on complete CAS entries
    #                if( (center_frame_right.cas1NumEntry.get()!="" and center_frame_right.cas1PercEntry.get()=="") or
    #                    (center_frame_right.cas1NumEntry.get()=="" and center_frame_right.cas1PercEntry.get()!="") or
    #                    (center_frame_right.cas2NumEntry.get()!="" and center_frame_right.cas2PercEntry.get()=="") or
    #                    (center_frame_right.cas2NumEntry.get()=="" and center_frame_right.cas2PercEntry.get()!="") or
    #                    (center_frame_right.cas3NumEntry.get()!="" and center_frame_right.cas3PercEntry.get()=="") or
    #                    (center_frame_right.cas3NumEntry.get()=="" and center_frame_right.cas3PercEntry.get()!="") or
    ...
    #                    (center_frame_right.cas4NumEntry.get()=="" and center_frame_right.cas4PercEntry.get()!="") or
    #                    (center_frame_right.cas5NumEntry.get()!="" and center_frame_right.cas5PercEntry.get()=="") or
    #                    (center_frame_right.cas5NumEntry.get()=="" and center_frame_right.cas5PercEntry.get()!="") ):
    #
    #                        # message box
    #                        mb.showinfo("Confirm entry","Please input a CAS number AND a max % for each CAS entry.")
    #
    ...
    #            if casNumConfirmed==True:
    #                # gather all entries
    #                casNumArr=[center_frame_right.cas1NumEntry.get(),
    #                            center_frame_right.cas2NumEntry.get(),
    #                            center_frame_right.cas3NumEntry.get(),
    #                            center_frame_right.cas4NumEntry.get(),
    #                            center_frame_right.cas5NumEntry.get()]
    #                casPercArr=[center_frame_right.cas1PercEntry.get(),
    #                            center_frame_right.cas2PercEntry.get(),
    #                            center_frame_right.cas3PercEntry.get(),
    #                            center_frame_right.cas4PercEntry.get(),
    #                            center_frame_right.cas5PercEntry.get()]
    #                df_chemName=[center_frame_right.chemNameEntryRec.get()]*len(casNumArr)
    #                df_onsiteQuantUnits=[center_frame_right.comboBoxUnitsRec_selection.get()]*len(casNumArr)
    #                df_onsiteQuant=[(int(center_frame_right.onsiteQuantEntryRec.get())+int(center_frame_right.recvdQuantEntryRec.get()))]*len(casNumArr)
    #                df_onsiteQuant_date=["NA"]*len(casNumArr)
    #                df_maxOnsiteQuant=[(int(center_frame_right.onsiteQuantEntryRec.get())+int(center_frame_right.recvdQuantEntryRec.get()))]*len(casNumArr)
    #                df_maxOnsiteQuant_date=["NA"]*len(casNumArr)
    #                df_casQuant=["NA"]*len(casNumArr)
    #                df_ehsFlag=["NA"]*len(casNumArr)
    #                df_reportFlag=["NA"]*len(casNumArr)
    ...
    #                    "Chemical name: "+df_dict["chemName"][0]+"\n"+
    #                    "Units: "+df_dict["onsiteQuantUnits"][0]+"\n"+
    #                    "Onsite qty: "+str(center_frame_right.onsiteQuantEntryRec.get())+"\n"+
    #                    "Recvd qty: "+str(center_frame_right.recvdQuantEntryRec.get())+"\n\n"+
    #                    "CAS #1: "+df_dict["chemConstCas"][0]+"; Max CAS %: "+str(df_dict["casPercent"][0])+"\n"+
    #                    "CAS #2: "+df_dict["chemConstCas"][1]+"; Max CAS %: "+str(df_dict["casPercent"][1])+"\n"+
    #                    "CAS #3: "+df_dict["chemConstCas"][2]+"; Max CAS %: "+str(df_dict["casPercent"][2])+"\n"+
    #                    "CAS #4: "+df_dict["chemConstCas"][3]+"; Max CAS %: "+str(df_dict["casPercent"][3])+"\n"+
    ...
    #        # logical to check if data was entered
    #        if (center_frame_right.onsiteQuantEntryRec.get()=="" or
    #            center_frame_right.recvdQuantEntryRec.get()==""):
    #            
    #            # message box
    #            mb.showinfo("Confirm entry","Quantity onsite and quantity received must be entered.")
    #
    ...
    #
    #            # set up dict
    #            df_dict={'chemName':center_frame_right.comboBoxChem_selection.get(),
    #                    'onsiteQuantUnits':epcradat.onsiteQuantUnits[epcradat.chemName==comboBoxChem_selection.get()].iloc[0],
    #                    'onsiteQuant':(int(center_frame_right.onsiteQuantEntryRec.get())+int(center_frame_right.recvdQuantEntryRec.get()))}
    #            
    #            # code for confirmatory popup box
    #            popuptextLS=("Please confirm the information that you entered\n\n"+
    #                "Chemical name: "+df_dict["chemName"]+"\n"+
