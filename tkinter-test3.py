        ...
        def on_select(event):
            ...
            if event.widget.name=="cb1":
                ...
                if event.widget.get()!="Not listed":
                    ...
                    unitsStr=epcradat.onsiteQuantUnits[epcradat.chemName==event.widget.get()].iloc[1]
        ...
        def submitData():
            ...
            if(comboBoxChem_selection.get()=="Not listed"):
                ...
                df_dict={'chemName':comboBoxChem_selection.get(),
                        'onsiteQuantUnits':epcradat.onsiteQuantUnits[epcradat.chemName==comboBoxChem_selection.get()].iloc[1],
