...
class Window:
    ...
    def popBlankWindow(self,root,height,width,center_frame,btm_frame,dataDirUpdatefiles,dataDirDbfiles):
        ...
        def depopFrame():
            ...
            chemNameEntryRec.delete(0,"end")
            onsiteQuantEntryRec.delete(0,"end")
            recvdQuantEntryRec.delete(0,"end")
            cas1NumEntry.delete(0,"end")
            cas1PercEntry.delete(0,"end")
            cas2NumEntry.delete(0,"end")
            cas2PercEntry.delete(0,"end")
            cas3NumEntry.delete(0,"end")
            cas3PercEntry.delete(0,"end")
            cas4NumEntry.delete(0,"end")
            cas4PercEntry.delete(0,"end")
            cas5NumEntry.delete(0,"end")
            cas5PercEntry.delete(0,"end")
            label6.config(text="Units:")
        ...
        onsiteQuantEntryRec=tk.Entry(center_frame_right, validate="key", validatecommand=(self.root.register(validate_int), "%S"))
        recvdQuantEntryRec=tk.Entry(center_frame_right, validate="key", validatecommand=(self.root.register(validate_int), "%S"))

        cas1NumEntry=tk.Entry(center_frame_right)
        cas1PercEntry=tk.Entry(center_frame_right, validate="key", validatecommand=(self.root.register(validate_float), "%P", "%S"))

        cas2NumEntry=tk.Entry(center_frame_right)
        cas2PercEntry=tk.Entry(center_frame_right, validate="key", validatecommand=(self.root.register(validate_float), "%P", "%S"))

        cas3NumEntry=tk.Entry(center_frame_right)
        cas3PercEntry=tk.Entry(center_frame_right, validate="key", validatecommand=(self.root.register(validate_float), "%P", "%S"))

        cas4NumEntry=tk.Entry(center_frame_right)
        cas4PercEntry=tk.Entry(center_frame_right, validate="key", validatecommand=(self.root.register(validate_float), "%P", "%S"))

        cas5NumEntry=tk.Entry(center_frame_right)
        cas5PercEntry=tk.Entry(center_frame_right, validate="key", validatecommand=(self.root.register(validate_float), "%P", "%S"))
